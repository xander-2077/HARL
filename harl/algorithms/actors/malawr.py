"""Actor of MALAWR algorithm."""
import numpy as np
import torch
import torch.nn as nn
from harl.utils.envs_tools import check
from harl.utils.models_tools import get_grad_norm
from harl.algorithms.actors.off_policy_base import OnPolicyBase


class MALAWR(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        """Initialize MALAWR algorithm.
        Args:
            args: (dict) arguments.
        ...
        """
        super(MALAWR, self).__init__(args, obs_space, act_space, device)
